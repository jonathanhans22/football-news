...
from main.views import add_news_entry_ajax, delete_news, show_main, create_news, show_news, show_xml, show_json, show_xml_by_id, show_json_by_id, register, last_login,logout_user,login_required, edit_news, create_news_flutter
app_name = 'main'
...
urlpatterns = [
    ...
    path('login/', last_login, name='login'),
